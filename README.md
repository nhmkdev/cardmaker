...
Latest stable (I hope) release binary: [Download 1.0.0.0](https://github.com/nhmkdev/cardmaker/releases/tag/v.1.0.0.0) (there have been a ton of releases before 1.0.0.0... this is anything but brand new software)
